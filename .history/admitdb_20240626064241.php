...
include 'connect.php';
/*inclusion de archivos y variables para almacenar campo del formulario*/
...
/*Verificacion del paciente existente*/
...
if($rowpet['pet_id']==$admm_pid){
    $hos = '<br/ ><div style="font-size:12px" align="center" class="alert alert-danger">Paciente actualmente admitido en el hospital!</div>';
}else{
/*actualizacion de la disponibilidad del quirofano*/
    if($admm_rom == "1"){
