...
<h1 class="text-center ">Clinica el avila<br /><small style="font-size:20px">Sistema Adminsitrativo de quirofano</small></h1></div>
<div class="container">
<div class="row">
<div class="col-md-12 col-xs-12 ">
<br></p>
...
<h3 style="font-family:calibri;" class="text-center">Información de Personal</h3></div>
</div>
</div>
</div>
<div class="container">
...
<h4 style="font-family:calibri;" class="text-center alert alert-danger">Ingrese los detalles de la súper administración para iniciar sesión</h4>
</div>
</div>
</div>
<div class="container">
<table style="background-color: rgba(222,444,444,0.0);" class="table table-responsive" width="500" border="0"><form action="" method="post">
  <tr>
    <td><input style="font-size:12px" type="text" name="searvalu" class="form-control" placeholder="Ingresar número de registro / Número de contacto / Correo / Nombre o grupo sanguíneo" /></td>
  </tr><tr align="center">
...
<footer>
	<hr />
    <center>< style="color:#FFF">Desarrollado por Unihumbolt</center>
</footer>
</html>
