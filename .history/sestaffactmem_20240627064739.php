...
<h3 style="font-family:calibri;" class="text-center">Búsqueda de información de Personal</h3></div>
</div>
<table style="background-color: rgba(255,255,255,0.0);" class="table table-responsive" width="500" border="0"><form action="" method="post">
  <tr>
    <td><input style="font-size:12px" type="text" name="searvalu" class="form-control" placeholder="Ingrese número de registro / Número de Contacto / Correo / Nombre o perfil de empleado" /></td>
  </tr><tr align="center">
...
<h4 style=" color:">
Numero de registro : <?php echo $row["staffID"]; ?><br />
Nombre Personal : <?php echo $row["smfname"]; ?> <?php echo $row["smlname"]; ?><br />
</h4>
...
<dt style="font-size:12px;"><strong>Numero de contacto : </strong>
...
<dt style="font-size:12px;"><strong>Genero: </strong></dt>
<dd style="font-size:12px;"><?php echo $row["smgender"]; ?></dd>

<dt style="font-size:12px;"><strong>Tipo de miembro: </strong></dt></dt>
<dd style="font-size:12px;"><?php echo $row["smtype"]; ?></dd>

<dt style="font-size:12px;"><strong>Turno de trabajo: </strong></dt></dt>
