...
<?php $count++; } ?>
  ...
  <tr>
    <td colspan="2" style="padding:5px"><div class="input-group col-md-12 col-xs-12 "> <span style="border-radius:0px; width:10px" class="input-group-addon" id="basic-addon1">+58</span><input  pattern="\d{11,11}"  maxlength="11" title="Número de móvil no válido Utilice solo las letras y el número de caracteres debe ser 11" name="tel" required  type="text" class="form-control" placeholder="Número de contacto" style="border-radius:0px"></div><script type="text/javascript">
