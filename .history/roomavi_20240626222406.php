...
<div class="row">
<div class="col-md-6 col-md-push-3 col-xs-12">
<div class="alert alert-info">Al hacer clic en Información del médico puede obtener información sobre el médico, al hacer clic en Información del paciente puede obtener información sobre el paciente admitido, al hacer clic en Actualizar información del quirofano puede actualizar la información del quirofano</div>
</div>
</div>
</div>
  ...
  <th><strong>Disponibilidad del quirofano</strong></th>
  ...
  <?php
  $count=1;
  $sel_query="SELECT hospi_room.room_petID,hospi_room.eroom_drid,hospi_room.room_id,hospi_room.room_name,hospi_room.room_avilabl,hospi_room.room_drid,hospi_room.rc_time_mo,hospi_room.rc_time_ev,staff.smfname,staff.smlname, hospi_room.rc_start_time, hospi_room.rc_end_time
  FROM hospi_room
  LEFT JOIN staff
  ...
  <tr valign="middle">
      ...
      <td  align="center"><a href="roomup.php?id=<?php echo $row["room_id"]; ?>" name="ad">Actualizar Información del Quirofano</a></td>
