...
<h3 style="font-family:calibri;" class="text-center">Formulario de registro de admisión de pacientes</h3>
</div>
<br />
<div class="container">
<div class="row">
<div class="col-md-4 col-md-push-4 col-xs-12 alert alert-success text-center">Pacientes registrados en este foro o admitidos en la clinica.</div>
</div>
</div>
...
<?php
/*Recuperación de datos de paciente seleccionado en un iD en especifico*/
$id=$_REQUEST['id'];
...
<form method="post" action="">
    <!-- Este formulario se utiliza para recopilar información del paciente para una admisión.ademas de mostrar sus debidos datos. -->
...
<input name="adm_pid" value="<?php echo $row["pet_id"]; ?>" type="hidden" class="form-control" placeholder="ID de paciente" >
...
<input name="adm_name" value="<?php echo $row["pet_fn"]; ?> <?php echo $row["pet_sn"]; ?>" type="hidden" class="form-control" placeholder="Nombre de paciente">
...
<input name="adm_age" value="<?php echo $row["pet_age"]; ?>" type="hidden" class="form-control" placeholder="Patient Age">
...
<input name="adm_con" value="<?php echo $row["pet_ac"]; ?> <?php echo $row["pet_con"]; ?>" type="hidden" class="form-control" placeholder="Número de Contacto de Paciente">
...
<input name="adm_bg" value="<?php echo $row["pet_bg"]; ?>" type="hidden" class="form-control" placeholder="Grupo sanguíneo paciente">
<div align="left">  Padecimiento por intervenir del Paciente :</div>
<input required name="pet_disea" value="" style="margin:5px;  border-radius:0px" type="text" class="form-control" placeholder="Motivo">
<select required name="adm_rn" style="margin:5px;  border-radius:0px" class="form-control">
<option value="">Seleccionar Quirofano</option>

<?php
/*genera dinámicamente las opciones del campo de selección de habitaciones disponibles en el formulario de admisión, basándose en los datos de la tabla hospi_room en la base de dato*/
$count = 1;
