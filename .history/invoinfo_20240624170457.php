...
<th><strong>Cargos de Intervencion quirurgica</strong></th>
...
<tr>
    ...
    <td align="center">$. <?php echo $row["doc_charge"]; ?> </td>
    <td align="center">$. <?php echo $row["medi_charge"]; ?> </td>
    <td align="center">$. <?php echo $row["hos_charge"]; ?> </td>
    <td align="center">$. <?php echo $row["total_charge"]; ?></td>
