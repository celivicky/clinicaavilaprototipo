...
<h1 class="text-center ">Clinica el Avila<br /><small style="font-size:20px">Sistema de administracion de Quirofano</small></h1></div>
...
<?php
/*Selecciona la informacion del paciente y admite segun el ID especificado*/
$id=$_REQUEST['id'];
...
<div align="left">ID del Paciente:</div>
...
<div align="left">Celular del Paciente:</div>
...
<div align="left">Motivo por intervenir: </div>
