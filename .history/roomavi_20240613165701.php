...
<h1 class="text-center ">Clinica el Avila<br /><small style="font-size:20px">Sistema Administrativo de Hospitales</small></h1></div>
...
<h3 style="font-family:calibri;" class="text-center">Cuartos Disponibles</h3></div>
<br />
<div class="container">
<div class="row">
...
<tr>
  <td style="border: 5px solid black" id="r1" height="100"><center><div id="">Cuarto No: 1<img id="rr1" width="32px" src="images/info.png"></div><center></td>
  <td style="border: 5px solid black" id="r2" height="100"><center>Cuarto No: 2<img id="rr2" width="32px" src="images/info.png"></center></td>
  <td style="border: 5px solid black" id="r3" height="100"><center>Cuarto No: 3<img id="rr3" width="32px" src="images/info.png"></center></td>
  <td style="border: 5px solid black" id="r4" height="100"><center>Cuarto No: 4<img id="rr4" width="32px" src="images/info.png"></center></td>
  <td style="border: 5px solid black" id="r5" height="100"><center>Cuarto No: 5<img id="rr5" width="32px" src="images/info.png"></center></td>
</tr>
<tr>
...
while($row = mysqli_fetch_assoc($result)) { ?>
  ID Paciente   : <?php echo $row["pet_id"]; ?><br>
  Nombre Paciente : <?php echo $row["admit_name"]; ?><br>
  Edad Paciente  : <?php echo $row["admit_age"]; ?><br>
  Grupo Sanguíneo : <?php echo $row["admit_bg"]; ?><br>
  Enfermedades : <?php echo $row["pet_des"]; ?>
...
<div class="alert alert-info">Al hacer clic en Información del médico puede obtener información sobre el médico, al hacer clic en Información del paciente puede obtener información sobre el paciente admitido, al hacer clic en Actualizar información de la habitación puede actualizar la información de la habitación</div>
  ...
  <th><strong>ID de Quirofano</strong></th>
  ...
  <th><strong>Hora Comienzo de cirugia</strong></th>
  <th><strong>Hora de Terminar la cirugia</strong></th>
  <th></th>
  </tr>
  </thead>
  <tbody>
