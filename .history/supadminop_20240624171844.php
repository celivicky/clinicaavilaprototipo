...
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="supadminop.php"><strong>Modificar información de Paciente</strong></a></li>
<li style="font-family:calibri; font-size:16px;"><a style="color:#000" href="supadminopsm.php"><strong>Modificar información de Personal</strong></a></li>
</ul>
</div></div>
...
<h3 style="font-family:calibri;" class="text-center">Información del Paciente</h3></div>
</div>
</div>
</div>
<div class="container">
...
<h4 style="font-family:calibri;" class="text-center alert alert-danger">Pulsa el botón de buscar para ver todos los detalles</h4>
</div>
</div>
</div>
<div class="container">
<table style="background-color: rgba(222,444,444,0.0);" class="table table-responsive" width="500" border="0"><form action="" method="post">
  <tr>
    <td><input style="font-size:12px" type="text" name="searvalu" class="form-control" placeholder="Ingresa número de registro / Número celular/ Correo electrónico / Nombre o grupo sanguíneo" /></td>
  </tr><tr align="center">
...
<form class="" action="" method="post" id="upform">
  ...
  <dt style="font-size:12px;"><strong>No Registro de Paciente :</strong> </dt>
  <dd style="font-size:12px;"><?php echo $row["pet_id"]; ?></dd>

  <dt style="font-size:12px;"><strong>Nombre de Paciente : </strong> </dt>
  ...
  <dt style="font-size:12px;"><strong>Apellido de Paciente : </strong> </dt>
  ...
  <dt style="font-size:12px;"><strong>Grupo sanguíneo: </strong></dt></dt>
  <dd style="font-size:12px;">
  ...
  <input name="ptel" id="tel" disabled type="text" class="form-control" value="<?php echo $row["pet_con"]; ?>" placeholder="Usuario" aria-describedby="basic-addon1 ">
  </dd>

  <dt style="font-size:12px;"><strong>Doctor asignado: </strong></dt>
  ...
  <dt style="font-size:12px;"><strong>Ingresado por: </strong></dt>
  ...
  <dt style="font-size:12px;"><strong>Hora y fecha del ingreso: </strong></dt>
  ...
  <dt style="font-size:12px;"><strong>Actualizado por: </strong></dt>
  ...
  <dt style="font-size:12px;"><strong>Fecha y hora actualización: </strong></dt>
...
<dl>
  ...
  <li style="background-color:rgba(255, 255, 255, 0.3);"><a href="suadpeted.php?id=<?php echo $row["pet_id"]; ?>" style="colour:#000">Actualizar</a></li>
  <li style="background-color:rgba(255, 255, 255, 0.3);"><a href="deletepet.php?id=<?php echo $row["pet_id"]; ?>" style="colour:#000">Eliminar</a></li>
  </ul>
