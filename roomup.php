...
<h3 style="font-family:calibri;" class="text-center">Actualización de Detalles de Quirofano </h3></div>
<br />
<div class="container">
<div class="row">
<div class="col-md-4 col-md-push-4 col-xs-12 alert alert-success text-center">Seleccione Doctor para la intervencion</div>
</div>
</div>
...
<h3 class="panel-title text-center">Formulario de actualización de detalles del quirofano</h3>
</div>
<center>
...
?>
  ...
  <div align="left">  ID Quirofano :</div>
...
<div align="left">  Nombre de Quirofano :</div>
...
<div align="left"> Seleccionar doctor para el cargo matutino :</div>
    ...
    <div align="left"> Seleccionar doctor para el cargo de la tarde :</div>
        ...
        <div align="left"> Hora de comienzo de cirugia :</div> <input name="rc_start_time" style="margin:5px; border-radius:0px" type="text" class="form-control" placeholder="Hora de comienzo de cirugia">
         <div align="left">Hora de fin de cirugia :</div> <input name="rc_end_time" style="margin:5px; border-radius:0px" type="text" class="form-control" placeholder="Hora de fin de cirugia">
