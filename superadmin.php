...
<h1 class="text-center ">Clinica el avila<br /><small style="font-size:20px">Administracion de area de quirofano</small></h1>
</div>
</div>
</div>
<br />
...
include 'connect.php';
session_start();
//este código es una página de inicio de sesión para un sistema de administración que verifica la autenticidad del usuario y redirige al usuario a una página de acceso restringido si los credenciales son correcto
