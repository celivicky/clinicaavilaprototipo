...
<h4 style=" color:">
Numero del Paciente : <?php echo $row["pet_id"]; ?><br />
Nombre del Paciente : <?php echo $row["pet_fn"]; ?> <?php echo $row["pet_sn"]; ?><br />
OPD Doctor asignado : <?php echo $row["Pet_opdid"]?>| <a target="_blank" href="admitdf.php?id= <?php echo $row["Pet_opdid"]; ?>" name="ad"> More Information </a>
</h4>

<dl class="dl-horizontal">

<dt style="font-size:12px;"><strong>Cumpleanos     : </strong></dt>
...
<li style="background-color:rgba(255, 255, 255, 0.3);"><a style="colour:#000" target="_blank" href="admit.php?id=<?php echo $row["pet_id"]; ?>" name="ad">Admisión al Hospital</a></li>
