  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav">
        <li><a  href="patin.php">Información del Paciente</a></li>
        <li><a  href="staff.php">Información del Personal</a></li>
        <li><a  href="invoinfo.php">Facturas de Pacientes</a></li>
        <li><a  href="roomavi.php">Información de los Quirofanos</a></li>
