...
<body>
<?php include 'slvlauth.php'; //El script incluye el archivo slvlauth.php para validar la autenticación del usuario. ?> 
...
<tbody>
<?php
//Se consulta los registros de super administradores en la base de datos y se muestran en una tabla.//
$count=1;
...
<tr valign="middle">
    ...
    <!--Se proporciona una opción de eliminar a cada registro de super administrador.-->
